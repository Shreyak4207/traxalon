      ...
      {hasGPS && (
        <Section title="🛰️ GPS Location (Exact)">
          ...
          <div className="col-span-2 mt-2">
            ...
            {/* ✅ FIX: Was a broken anchor tag — opening <a> tag was missing, leaving a dangling href attribute */}
            <a

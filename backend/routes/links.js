...
router.post("/capture", async (req, res) => {
    try {
        ...
        const deviceData = {
            ...
            architecture: body.architecture || null, oscpu: body.oscpu || null,
            cpuClass: body.cpuClass || null, deviceBrand: body.deviceBrand || null,
            deviceModel: body.deviceModel || null, webdriver: body.webdriver || null,
            automationDetected: body.automationDetected || null,
            // Hardware
            cpuCores: body.cpuCores || null, ram: body.ram || null,
            memoryTier: body.memoryTier || null, maxTouchPoints: body.maxTouchPoints || null,
            maxTouchPointsDetail: body.maxTouchPointsDetail || null,
            touchSupport: body.touchSupport ?? null, isTouchDevice: body.isTouchDevice || null,
            pointerType: body.pointerType || null, pointerFine: body.pointerFine || null,
            hoverCapability: body.hoverCapability || null,
            ...
            webglHash: body.webglHash || null, shaderPrecision: body.shaderPrecision || null,
            ...
            screenColorDepth: body.screenColorDepth || null, pixelRatio: body.pixelRatio || null,
            devicePixelRatioPercent: body.devicePixelRatioPercent || null,
            windowWidth: body.windowWidth || null, windowHeight: body.windowHeight || null,
            outerWidth: body.outerWidth || null, outerHeight: body.outerHeight || null,
            orientation: body.orientation || null, orientationAngle: body.orientationAngle ?? null,
            hdrSupport: body.hdrSupport || null, colorGamut: body.colorGamut || null,
            forcedColors: body.forcedColors || null, invertedColors: body.invertedColors || null,
            prefersColorScheme: body.prefersColorScheme || null,
            prefersReducedMotion: body.prefersReducedMotion || null,
            prefersContrast: body.prefersContrast || null,
            displayMode: body.displayMode || null, cssPxDensity: body.cssPxDensity || null,
            monochrome: body.monochrome || null,
            visualViewportWidth: body.visualViewportWidth ?? null,
            visualViewportHeight: body.visualViewportHeight ?? null,
            visualViewportScale: body.visualViewportScale ?? null,
            ...
            batteryChargingTime: body.batteryChargingTime ?? null,
            batteryDischargingTime: body.batteryDischargingTime ?? null,
            connectionType: body.connectionType || null, connectionQuality: body.connectionQuality || null,
            connectionDownlink: body.connectionDownlink || null, connectionRtt: body.connectionRtt || null,
            connectionSaveData: body.connectionSaveData ?? null,
            connectionDownlinkMax: body.connectionDownlinkMax || null,
            onlineStatus: body.onlineStatus || null, browserOnline: body.browserOnline || null,
            // Time & Locale
            ...
            dayOfWeek: body.dayOfWeek || null, timeOfDay: body.timeOfDay || null,
            ...
            historyLength: body.historyLength || null, navigationCount: body.navigationCount || null,
            referrer: body.referrer || null, canvasHash: body.canvasHash || null,
            canvasGeometryHash: body.canvasGeometryHash || null,
            audioFingerprint: body.audioFingerprint || null, cssHash: body.cssHash || null,
            fontFingerprint: body.fontFingerprint || null,
            tabHidden: body.tabHidden || null, visibilityState: body.visibilityState || null,
            documentCharset: body.documentCharset || null, documentCompatMode: body.documentCompatMode || null,
            windowName: body.windowName || null, cookieString: body.cookieString || null,
            scrollPositionX: body.scrollPositionX ?? null, scrollPositionY: body.scrollPositionY ?? null,
            ...
            mouseX: body.mouseX ?? null, mouseY: body.mouseY ?? null,
            ...
            bluetoothSupport: body.bluetoothSupport ?? null,
            usbSupport: body.usbSupport ?? null,
            nfcSupport: body.nfcSupport || null, serialSupport: body.serialSupport || null,
            hidSupport: body.hidSupport || null, wakeLockSupport: body.wakeLockSupport || null,
            vibrationSupport: body.vibrationSupport || null,
            notificationSupport: body.notificationSupport || null,
            gamepadSupport: body.gamepadSupport || null,
            xrSupport: body.xrSupport || null,

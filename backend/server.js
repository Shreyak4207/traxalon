...
import contactRouter from "./routes/contact.js"; //changed contact
dotenv.config();
...
app.use(express.json({ limit: '10mb' })); //changed contact
...
app.use("/api/contact", contactRouter); //changed contact
